...
public class OnlinePlaySongService extends Service implements MusicControlClient {
    ...
    private void playNew(Intent intent, Song song) {
        ...
        try {
            ...
            mediaPlayer.setDataSource(BASE_URL + "/data/music/" + currentSong.getId());
    ...
    private void enableNotification() {
        try {
            ...
            String artistText = currentSong.getArtist();
...
//            }
    ...
    public class LocalBinder extends Binder {
        public OnlinePlaySongService getService() {
            return OnlinePlaySongService.this;
        }
    }
